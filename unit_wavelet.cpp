...
int main(int argc, char *argv[]){
    ...
    image->perform_boundary_extension_symmetric();
    ...
    for(int r = 0; r < 8; r++){
        for(int c = 0; c < 8; c++){
            //printf("r = %d, c = %d, image_a53_l1 = %f, buf_a53_l1 = %f\n", r, c, image_a53_l1->buf[r*image_a53_l1->stride+c], buf_a53_l1[r*8+c]);
    ...
    float buf_a53_l2[64] = {-1.05486297600,  0.00000000000, -0.057365417480,  0.00000000000,  0.35727310180, -0.03564453125,  0.178222656300,  0.0712890625,
                             0.00000000000,  0.00195312500,  0.000000000000,  0.00195312500, -0.01782226563, -0.03369140625,  0.089111328130, -0.0693359375,
                            -0.05736541748,  0.00000000000, -0.061820983890, -0.01782226563,  0.14062881470,  0.10693359380, -0.008911132813, -0.1782226563,
                             0.00000000000,  0.00195312500, -0.017822265630, -0.03369140625,  0.10693359380, -0.03369140625, -0.017822265630,  0.0019531250,
                             0.35727310180, -0.01782226563,  0.140628814700,  0.10693359380,  0.79141235350, -0.01782226563, -0.191867828400, -0.1425781250,
                            -0.03564453125, -0.03369140625,  0.106933593800, -0.03369140625, -0.01782226563,  0.00195312500,  0.000000000000,  0.0019531250,
                             0.17822265630,  0.08911132813, -0.008911132813, -0.01782226563, -0.19186782840,  0.00000000000,  0.008354187012, -0.1425781250,
                             0.07128906250, -0.06933593750, -0.178222656300,  0.00195312500, -0.14257812500,  0.00195312500, -0.142578125000,  0.0019531250};

    image_a53_l1->perform_boundary_extension_symmetric();

    float buf_a53_l1_extended[(8+2*boundary)*(8+2*boundary)] = {
         0.00195312500, -0.01782226563, -0.03369140625,  0.10693359380, -0.03369140625, -0.03564453125, -0.03369140625,  0.10693359380, -0.03369140625, -0.01782226563,  0.00195312500,  0.00000000000,  0.0019531250,  0.00000000000,  0.00195312500, -0.01782226563, -0.03369140625,  0.10693359380,
        -0.01782226563,  0.82482910160,  0.10693359380,  0.82482910160, -0.01782226563,  0.12084960940, -0.01782226563,  0.82482910160,  0.10693359380,  0.82482910160, -0.01782226563,  0.05847167969, -0.1425781250,  0.05847167969, -0.01782226563,  0.82482910160,  0.10693359380,  0.82482910160,
        -0.03369140625,  0.10693359380, -0.03369140625, -0.01782226563,  0.00195312500,  0.00000000000,  0.00195312500, -0.01782226563, -0.03369140625,  0.10693359380, -0.03369140625, -0.01782226563,  0.0019531250, -0.01782226563, -0.03369140625,  0.10693359380, -0.03369140625, -0.01782226563,
         0.10693359380,  0.82482910160, -0.01782226563,  0.12976074220,  0.00000000000, -0.43164062500,  0.00000000000,  0.12976074220, -0.01782226563,  0.82482910160,  0.10693359380,  0.74462890630, -0.1782226563,  0.74462890630,  0.10693359380,  0.82482910160, -0.01782226563,  0.12976074220,
        -0.03369140625, -0.01782226563,  0.00195312500,  0.00000000000,  0.00195312500,  0.00000000000,  0.00195312500,  0.00000000000,  0.00195312500, -0.01782226563, -0.03369140625,  0.08911132813, -0.0693359375,  0.08911132813, -0.03369140625, -0.01782226563,  0.00195312500,  0.00000000000,
         0.00195312500, -0.01782226563, -0.03369140625,  0.10693359380, -0.03369140625, -0.03564453125, -0.03369140625,  0.10693359380, -0.03369140625, -0.01782226563,  0.00195312500,  0.00000000000,  0.0019531250,  0.00000000000,  0.00195312500, -0.01782226563, -0.03369140625,  0.10693359380,
        -0.01782226563,  0.82482910160,  0.10693359380,  0.82482910160, -0.01782226563,  0.12084960940, -0.01782226563,  0.82482910160,  0.10693359380,  0.82482910160, -0.01782226563,  0.05847167969, -0.1425781250,  0.05847167969, -0.01782226563,  0.82482910160,  0.10693359380,  0.82482910160,
        -0.03369140625,  0.10693359380, -0.03369140625, -0.01782226563,  0.00195312500,  0.00000000000,  0.00195312500, -0.01782226563, -0.03369140625,  0.10693359380, -0.03369140625, -0.01782226563,  0.0019531250, -0.01782226563, -0.03369140625,  0.10693359380, -0.03369140625, -0.01782226563,
    ...
    for(int r = 0; r < 8+2*boundary; r++){
        for(int c = 0; c < 8+2*boundary; c++){
            //printf("%f ", image_a53_l1->handle[r*image_a53_l1->stride+c]);
            //printf("r = %d, c = %d, image_a53_l2 = %f, buf_a53_l2 = %f\n", r, c, image_a53_l1->handle[r*image_a53_l1->stride+c], buf_a53_l1_extended[r*(8+2*boundary)+c]);
    ...
    for(int r = 0; r < 8; r++){
        for(int c = 0; c < 8; c++){
            //printf("r = %d, c = %d, image_a53_l2 = %f, buf_a53_l2 = %f\n", r, c, image_a53_l2->buf[r*image_a53_l2->stride+c], buf_a53_l2[r*8+c]);
    ...
    image_a53_l2->perform_boundary_extension_symmetric();

    float buf_a53_s53_l2[64] = {-1.00195312500,  0.00000000000, -0.43164062500,  0.00000000000,  0.12084960940, -0.03564453125,  0.42731475830,  0.0712890625,
                                 0.00000000000,  0.00195312500,  0.00000000000,  0.00195312500, -0.01782226563, -0.03369140625,  0.08911132813, -0.0693359375,
                                -0.43164062500,  0.00000000000,  0.12976074220, -0.01782226563,  0.82482910160,  0.10693359380,  0.16777801510, -0.1782226563,
                                 0.00000000000,  0.00195312500, -0.01782226563, -0.03369140625,  0.10693359380, -0.03369140625, -0.01782226563,  0.0019531250,
                                 0.12084960940, -0.01782226563,  0.82482910160,  0.10693359380,  0.82482910160, -0.01782226563, -0.22291946410, -0.1425781250,
                                -0.03564453125, -0.03369140625,  0.10693359380, -0.03369140625, -0.01782226563,  0.00195312500,  0.00000000000,  0.0019531250,
                                 0.42731475830,  0.08911132813,  0.16777801510, -0.01782226563, -0.22291946410,  0.00000000000, -0.12151908870, -0.1425781250,
                                 0.07128906250, -0.06933593750, -0.17822265630,  0.00195312500, -0.14257812500,  0.00195312500, -0.14257812500,  0.0019531250};
    ...
    image_a53_s53_l2->perform_boundary_extension_symmetric();
    ...
    for(int r = 0; r < 8; r++){
        for(int c = 0; c < 8; c++){
            printf("r = %d, c = %d, image_a53_s53_l1 = %f, buf_a53_s53_l1 = %f\n", r, c, image_a53_s53_l1->buf[r*image_a53_s53_l1->stride+c], buf_a53_s53_l1[r*8+c]);
